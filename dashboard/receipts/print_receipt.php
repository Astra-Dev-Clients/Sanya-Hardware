...
<div class="receipt">
  ...
  <div class="info">
    ...
    <p>Mpesa No.: <?= $sale['mpesa_number'] ?: '-' ?></p>
  </div>
  ...
  <div class="totals">
    <p><span>Amount Paid:</span> <span>KES <?= number_format($sale['amount_paid'], 2) ?></span></p>
...
<div class="noprint">
  <button class="btn btn-outline-dark btn-sm" onclick="window.print()">🖨️ Print Again</button>
</div>
</body>
</html>
