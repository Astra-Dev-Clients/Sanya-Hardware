...
<head>
    ...
    <style>
        ...
        .background-image {
            ...
            width: 100vw;
            height: 100vh;
            background: url('../../assets/img/bg/astra-2.jpg') center center/cover no-repeat;
            z-index: 0;
        }
        .overlay {
            position: fixed;
...
<div class="login-container">
    ...
    <form action="../../backend/astra_auth.php" method="POST">
        <div class="form-group">
            <label for="astra_id">Astra ID</label>
            <input type="text" id="astra_id" name="astra_id" required>
        </div>
        <div class="form-group">
